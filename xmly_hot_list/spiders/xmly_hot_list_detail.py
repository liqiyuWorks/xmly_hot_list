...
start_url = "http://m.ximalaya.com/business-content-sort-mobile-web/sortrule/189/contents/pagination/ts-1609911492811?device=iPhone&needFullVo=1&pageNum={}&pageSize=100&version="


class XmlyHotListDetailSpider(scrapy.Spider):
    name = 'xmly_hot_list_detail'
    ...
    def parse(self, response):
        ...
        for data in data_list:
            ...
            item["singlePrice"] = data.get('context').get('singlePrice')
            item["singleDiscountedPrice"] = data.get('context').get('singleDiscountedPrice')

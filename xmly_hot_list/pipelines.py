...
class XmlyHotListPipeline:
    ...
    def process_item(self, item, spider):
        ...
        sql = """insert into xmly_hot_list(contentId,title,price,discountedPrice,singlePrice,singleDiscountedPrice,priceTypeId,isPaid,customerTitle,playCount,cover,saleTypeId,albumType,hasPermission,expireTime,isSubscribed,supportVipDiscount)
